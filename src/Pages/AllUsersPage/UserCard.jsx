...
const UserCard = ({ user }) => {
  ...
  return (
    <div className="border bg-white border-zinc-200 shadow-md overflow-hidden rounded-lg md:block flex ">
      <div className="md:p-0 p-2 ">
        <Link to={`/profile/${user.username}`}>
          <img
            className="md:w-full w-24 md:h-56 h-22 object-cover scale md:rounded-none rounded-full"
